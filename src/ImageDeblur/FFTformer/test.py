...
def _eval(model, args):
    ...
    with torch.no_grad():
        ...
        for iter_idx, data in tqdm(enumerate(dataloader)):
            ...
            h_n = (32 - h % 32) % 32
            w_n = (32 - w % 32) % 32
            input_img = torch.nn.functional.pad(
                input_img, (0, w_n, 0, h_n), mode="reflect"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="./test_images/")

    # Test
    parser.add_argument(
        "--test_model", type=str, default="./pretrain_model/fftformer_GoPro.pth"
    )
